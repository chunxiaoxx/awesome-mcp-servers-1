...
- [Nautilus-compass](https://github.com/chunxiaoxx/nautilus-compass) - Local-first agent memory layer: zero LLM calls at write time, hybrid BM25+dense retrieval, drift detection; benchmarks ship as sealed, signed evidence packs
